...
export const RegisterPage = () => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setError(err.message || "Đã có lỗi xảy ra khi đăng ký bằng Google.");
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden p-4">
      ...
      <div className="max-w-md w-full z-10 animate-in fade-in zoom-in-95 duration-500">
          ...
          <div className="p-8 md:p-10">
            ...
            <div className="flex flex-col items-center mb-10 text-center">
              ...
              <p className="text-text-secondary text-sm max-w-[280px]">
                BlackStoneBook chỉ hỗ trợ đăng ký nhanh qua Google để đảm bảo tính bảo mật.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <Button
                ...
                disabled={loading}
                className="w-full h-14 bg-white hover:bg-gray-50 text-gray-900 font-bold rounded-2xl border border-gray-200 shadow-sm transition-all hover:shadow-md flex items-center justify-center gap-3 group overflow-hidden relative"
              >
                {loading ? (
              ...
              <div className="pt-6 border-t border-border-default/50">
                <div className="flex flex-col gap-4 text-center">
                  ...
                  <div className="bg-surface-raised/50 p-4 rounded-2xl flex items-center justify-between">
                    <span className="text-xs text-text-secondary font-medium">Đã có tài khoản?</span>
                    <Link
                      href="/dang-nhap"
        ...
        <div className="mt-8 flex justify-center gap-6 opacity-50 grayscale hover:opacity-100 hover:grayscale-0 transition-all duration-500">
          {/* Subtle brand/trust indicators if any */}
          <span className="text-[10px] font-bold uppercase tracking-widest text-text-muted">Secure Auth by Supabase</span>
        </div>
      </div>
    </div>
  );
