...
import {
  TranslationRule,
  TranslationRuleInsert,
} from "@/modules/translate/translate.type";
import {
  saveTranslationRuleAction,
  updateTranslationRuleAction,
      ...
      <DialogContent className="sm:max-w-[550px] bg-surface-card text-text-primary border-border-default">
        <DialogHeader>
          ...
          <DialogDescription className="text-text-muted text-xs">
            Định nghĩa các yêu cầu Prompt để AI thực hiện dịch thuật và xử lý dữ
            liệu chuẩn xác hơn.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="grid gap-2">
              <div className="flex items-center justify-between">
                <Label
                  ...
                  className="text-xs font-bold uppercase text-text-muted"
                >
                  Nội dung câu lệnh (Prompt)
                </Label>
                <span className="text-[10px] text-text-faint italic">
                  Sử dụng Markdown để AI dễ hiểu hơn
                </span>
              </div>
              <Textarea
                id="content"
